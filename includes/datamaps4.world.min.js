! function() {
	...
	function i(a, b, c) {
		...
		h.enter().append("svg:circle").attr("class", "datamaps-bubble").attr("cx", function(a) {
			var b;
			return d(a) ? b = e.latLngToXY(a.latitude, a.longitude) : a.centered && ( b = e.path.centroid(g.select("path."+a.centered).data()[0])), b ? b[0] :
			void 0
		}).attr("cy", function(a) {
			var b;
			return d(a) ? b = e.latLngToXY(a.latitude, a.longitude) : a.centered && ( b = e.path.centroid(g.select("path."+a.centered).data()[0])), b ? b[1] :
			void 0
	...
	k.prototype.draw = function() {
		...
		objects : {
			world : {
				...
				geometries : [{
					...
					id : "ISR",
					arcs : [[380, -252, 372, 373, 374]]  // [[-384, -371, 369, 370, 371, -252, 372, 373, 374]] -- B [[380, -252, 372, 373, 374]]
				}, {
					type : "MultiPolygon",
					properties : {
						name : "Italy"
					...
					id : "JOR",
					arcs : [[-370, 380, -366, 381, 382, -372]] //   A [[-370, 380, -366, 381, 382, -372, 383]] --  B [[-370, 380, -366, 381, 382, -372]] -- C [[-370, 380, -366, 381, 382, -372, 382]]
				}, {
					type : "MultiPolygon",
					properties : {
						name : "Japan"
		...
		"undefined" == typeof k.prototype[a] && (k.prototype[a] = function(c, d, e, f) {
			var g;
			"undefined" == typeof f && ( f = !1), "function" == typeof d && ( e = d, d =
			void 0), d = j(d || {}, n[a + "Config"]), !f && this.options[a + "Layer"] ? ( g = this.options[a + "Layer"], d = d || this.options[a + "Options"]) : ( g = this.addLayer(a), this.options[a + "Layer"] = g, this.options[a + "Options"] = d), b.apply(this, [g, c, d]), e && e(g)
		})
