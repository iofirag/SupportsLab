...
$(document).ready(function() {
	if (getParameterByName("ru")!=''){
		selected[0] = diagram.ru= getParameterByName("ru");
		selected[1]= diagram.rd= getParameterByName("rd");
		selected[2] = diagram.ld= getParameterByName("ld");
		selected[3] = diagram.lu= getParameterByName("lu");
		getBtnByCategory();
	}else{
